export const features = [
  {
    ...
    title: "The Challenge",
    text: "Plant diseases cause significant crop damage and economic losses. Traditional detection methods are time-consuming and require expert knowledge. Our solution provides a fast, reliable, and accessible alternative.",
    button: {
  ...
  },
  {
    ...
    text: (
      <ul>
        <li><strong>Early Detection:</strong> Prevent crop damage with timely disease identification.</li>
        <li><strong>Accurate Diagnosis:</strong> Ensure high accuracy using cutting-edge machine learning.</li>
        <li><strong>Accessibility:</strong> Simplify the process for farmers and agricultural professionals.</li>
        <li><strong>Treatment Recommendations:</strong> Provide actionable insights to mitigate damage.</li>
        <li><strong>Sustainable Farming:</strong> Support environmentally friendly farming practices.</li>
      </ul>
    ),
    button: {
...
export const details = [
  {
    ...
    title: "Instant diagnoses and recommendations for farmers.",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Empower agricultural officers to assist farmers.",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Aid in developing disease-resistant crops.",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Enhance crop quality and reduce losses.",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "How do I upload a photo of my plant?",
    answer:
      "You can easily upload a photo of your plant by clicking the Upload button on the homepage and selecting an image from your device. Make sure the photo is clear and high-quality for accurate diagnosis.",
  },
  {
    id: "1",
    question: "How accurate is the AI diagnosis?",
    answer:
      "Our AI uses a combination of machine learning models and plant disease databases to provide accurate diagnoses. While it's highly reliable, we recommend double-checking the results with a professional for critical cases.",
  },
  {
    id: "2",
    question: "What type of diseases can your AI detect?",
    answer:
      "Our AI can detect : Brown spot,Bacterial leaf blight in Rice and Red Dot in Sugarcane",
  },
  {
    id: "3",
    question: "Can I get advice on how to treat my plant diseases?",
    answer:
      "Yes! After diagnosis, you'll receive tailored treatment suggestions, including natural remedies and chemical treatments (if applicable) to help you address the issue and protect your crops.",
  },
  {
    id: "4",
    question: "Is my data secure on your platform?",
    answer:
      "Absolutely! We take data privacy seriously and follow industry-leading security practices to ensure your photos and personal information are kept safe and secure.",
  },
  {
    id: "5",
    question: "Can I use the platform for multiple types of plants?",
    answer:
      "Yes, our platform can analyze a variety of plants, including rice and sugarcane. Simply upload photos of these or any other plant types for accurate diagnosis and treatment recommendations.",
  },
];
