...
@layer utilities {
  ...
  /* START of Gradients */
  .g1 {
    background: linear-gradient(#daf1de60, transparent);
  }

  .g2 {
    background: linear-gradient(#235347, #163832);
  }

  .g3 {
    background: linear-gradient(#daf1de, #051f20);
  }

  .g4 {
    background: linear-gradient(#8eb69b, #0b2b26);
  }

  .g5 {
    background: linear-gradient(#163832, #0b2b26);
  }

  .g6 {
    background: linear-gradient(#163832, #051f20);
  }

  .g7 {
    background: linear-gradient(#235347, #051f20);
  }

  .g8 {
    background: linear-gradient(to right, transparent, #daf1de, transparent);
  }

  .g9 {
    background: linear-gradient(#051f20, transparent);
  }
